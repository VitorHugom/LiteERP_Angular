...
import { CadastroProdutoComponent } from './components/produtos-cadastro/produtos-cadastro.component';
...
export const routes: Routes = [
  ...
  { path: 'produtos/:id', component: CadastroProdutoComponent, canActivate: [AuthGuard], data: { expectedRoles: ['ROLE_GERENCIAL'] }},

...
export const routes: Routes = [
  ...
  { path: 'pagamentos', component: PagamentosComponent, canActivate: [AuthGuard], data: { expectedRoles: ['ROLE_GERENCIAL'] }},
  ...
  { path: 'recebimento', component: RecebimentoComponent, canActivate: [AuthGuard], data: { expectedRoles: ['ROLE_GERENCIAL'] }},
  ...
  { path: 'produtos-relatorio', component: ProdutosRelatorioComponent, canActivate: [AuthGuard], data: { expectedRoles: ['ROLE_GERENCIAL'] }},
